...
|-------|------|--------|-----------|
| Loose ends | Wire-or-delete L1–L8 (~~render~~✅, ~~selections~~✅, config_json, final stage, server paths, tax effect, EmailAlerter, skip-masking test) | 🟡 L1+L2 done; L3–L8 next | none |
